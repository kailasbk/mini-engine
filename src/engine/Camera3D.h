...
public:
     ...
     */
    explicit Camera3D(Mat4 projection);

    /**
     * Creates an orthographic camera with the given viewport width and height and
     ...
     * @returns a shared pointer to the camera
     */
    static std::shared_ptr<Camera3D> createOrthographic(float width, float height, float zNear, float zFar);

    /**
     * Creates a perspective camera with the given viewport field of view and aspect ratio
     ...
     * @returns a shared pointer to the camera
     */
    static std::shared_ptr<Camera3D> createPerspective(float fieldOfView, float aspectRatio, float zNear, float zFar);
     ...
     *
     * @param pitch the pitch m_angle change, in degrees
     * @param yaw the yaw m_angle change, in degrees
     * @param roll the roll m_angle change, in degrees
     */
