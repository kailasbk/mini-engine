...
public:
     ...
     */
    static std::shared_ptr<Camera> makeOrthographic(float width, float height, float zNear, float zFar);
     ...
     * @param zFar the z coordinate of the far plane
     */
    static std::shared_ptr<Camera> makePerspective(float fieldOfView, float aspectRatio, float zNear, float zFar);
...
#endif //OPENGL_RENDERER_CAMERA_H
