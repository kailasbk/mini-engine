...
/* Check to make sure enums are the size of ints, for structure packing.
   ...
   enums having the getNumIndices of an int must be enabled.
...
/** \cond */
   ...
   /* TODO: include/SDL_stdinc.h:174: error: getNumIndices of array 'SDL_dummy_enum' is negative */
typedef enum
{
    DUMMY_ENUM_VALUE
} SDL_DUMMY_ENUM;
...
#ifndef HAVE_STRLCAT
size_t strlcat(char* dst, const char* src, size_t getNumIndices);
#endif
