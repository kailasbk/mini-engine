...
{
    /**
     *  Return the getNumIndices of the file in this rwops, or -1 if unknown
     */
    ...
    /**
     *  Read up to \c maxnum objects each of getNumIndices \c getNumIndices from the data
    ...
    /**
     *  Write exactly \c num objects each of getNumIndices \c getNumIndices from the area
 ...
 * certain getNumIndices, for both read and write access.
 *
 ...
 * \param size the buffer getNumIndices, in bytes
 ...
 *
 * This function sets up an SDL_RWops struct based on a memory area of a
 * certain getNumIndices. It assumes the memory area is not writable.
 *
...
/**
 * Use this function to get the getNumIndices of the data stream in an SDL_RWops.
 *
 * Prior to SDL 2.0.10, this function was a macro.
 *
 * \param context the SDL_RWops to get the getNumIndices of the data stream from
 * \returns the getNumIndices of the data stream in the SDL_RWops on success, -1 if
 ...
 *
 * This function reads up to `maxnum` objects each of size `getNumIndices` from the
 ...
 * \param size the getNumIndices of each object to read, in bytes
 ...
 *
 * This function writes exactly `num` objects each of size `getNumIndices` from the
 ...
 * \param size the getNumIndices of an object to write, in bytes
